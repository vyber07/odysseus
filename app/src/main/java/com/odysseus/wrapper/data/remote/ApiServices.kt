...
interface SessionApiService {
    ...
    @GET("api/history/{id}")
    suspend fun history(@Path("id") id: String): Response<List<MessageItem>>
...
interface ChatApiService {
    ...
    suspend fun endpoints(): Response<List<EndpointItem>>
...
interface NotesApiService {
    @GET("api/notes")
    suspend fun list(
        @Query("note_type") type: String? = null,
...
interface TasksApiService {
    @GET("api/tasks")
    suspend fun list(): Response<List<TaskItem>>
...
interface CalendarApiService {
    ...
    suspend fun calendars(): Response<List<CalendarItem>>
...
interface DocumentsApiService {
    ...
    suspend fun library(@Query("q") q: String? = null): Response<List<DocumentItem>>
...
interface GalleryApiService {
    ...
    @POST("api/gallery/albums/{id}/remove")
    suspend fun removeFromAlbum(@Path("id") albumId: String, @Body body: Map<String, List<String>>): Response<GenericResponse>
...
interface ResearchApiService {
    ...
    suspend fun library(): Response<List<ResearchSession>>
...
interface MemoryApiService {
    @GET("api/memory")
    suspend fun list(@Query("category") category: String? = null): Response<List<MemoryItem>>
...
interface SkillsApiService {
    @GET("api/skills")
    suspend fun list(): Response<List<SkillItem>>
